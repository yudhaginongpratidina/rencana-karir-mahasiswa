  ...
  return (
    <div>
        ...
        <div class="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{" "}Sign up to platform{" "}</h2>
            <form class="mt-8 space-y-6" action="#">
                <Input type="email" title="Email"  name="Email" placeholder="name@company.com" />
                <Input type="password" title="Password" name="Password" placeholder="••••••••" />
                <Input type="password" title="Repeat Password" name="re_Password" placeholder="••••••••" />
...
const Auth = (props) => {
    return (
        <div class="text-sm font-medium text-gray-500"> 
            {" "} I have an account? {" "}
            <a href="/login" class="text-primary-700 hover:underline dark:text-primary-500">{" "}Login</a>
        </div>
    )
}