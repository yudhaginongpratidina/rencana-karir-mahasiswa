              ...
              <ul className="pb-2 space-y-2">
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="ml-3">Data Karir</span>
                  </Link>
                </li>
                <li>
                  <Link
                    to="/administrator/message"
                    className="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="ml-3">List Pesan</span>
                  </Link>
                </li>
                <li>
                  <Link to="/administrator/kriteria" className="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                    ...
                    <span className="ml-3">Form Kriteria</span>
                  </Link>
                </li>
              </ul>
            </div>
